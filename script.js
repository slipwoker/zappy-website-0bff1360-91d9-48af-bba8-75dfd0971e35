document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    function getFieldError(field) {
      ...
      if (value !== '') {
        ...
        if (field.tagName === 'TEXTAREA' && isRequired) {
          if (value.length < 10) {
    ...
    function validateForm() {
      const fields = contactForm.querySelectorAll(
        'input:not([type="submit"]):not([type="reset"]):not([type="button"]):not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, select'
      );
      let isValid = true;
        ...
        if (submitBtn) {
          ...
          setTimeout(function () {
            ...
            successEl.style.cssText =
              'color:#38a169;font-size:1em;margin-top:12px;font-weight:600;';
  ...
  const OBSERVE_CLASS = 'fade-in-on-scroll';
  ...
  animatableElements.forEach(function (el) {
    if (!el.classList.contains(OBSERVE_CLASS)) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '0bff1360-91d9-48af-bba8-75dfd0971e35',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '0bff1360-91d9-48af-bba8-75dfd0971e35';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '0bff1360-91d9-48af-bba8-75dfd0971e35';
